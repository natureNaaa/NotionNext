const CONFIG = {
  ...
  SIMPLE_LOGO_DESCRIPTION: process.env.NEXT_PUBLIC_THEME_SIMPLE_LOGO_DESCRIPTION || '<div style="text-align: left;"></div>RESEARCH INTEREST<br/>·Clinical Psychology<br/>·Adolescents and Children<br/>·Depression, ADHD, Autism<br/>·Neural Mechanism<br/>·Mindfulness Intervention</div>',
